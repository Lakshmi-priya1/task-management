export const milestoneStyles = {
  ...
  drawerTitle:    { fontWeight: 800, fontSize: 22, color: "text.primary" },
  drawerSubtitle: { fontSize: 13, color: "text.secondary", mt: 0.5 },
  sectionLabel:   { fontWeight: 700, mb: 1.5, color: "#6366f1" },
